...
object ColorPrefs {
    ...
    const val NUMBER_SELECTED_BG = "number_selected_bg"
    ...
    private val colorDefaults = mapOf(
        ...
        NUMBER_SELECTED_BG to R.color.number_selected_bg,
    ...
    fun getColor(context: Context, key: String): Int {
        val default = ContextCompat.getColor(context, colorDefaults[key] ?: return 0xFF000000.toInt())
    ...
    fun getShineEnabled(context: Context): Boolean =
        prefs(context).getBoolean(BUTTON_SHINE_ON, context.resources.getBoolean(R.bool.button_shine_enabled))
